...
The method I used attempts to solve the puzzle by recursively picking words that possess the most common letters. This will eliminate a large number from the word pool
